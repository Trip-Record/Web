...
const RegisterPage: React.FC<RegisterPageProps> = () => {
  ...
  return (
    <section className="flex flex-col items-center p-2 bg-gray-50">
      <h1 className="text-4xl mb-4 mt-4 text-center font-extrabold">
        회원가입
      </h1>
      <div className="flex flex-col w-full max-w-[500px] h-1/2 m-auto mt-10 items-center bg-white text-center rounded-lg text-black p-4 shadow">
